...
extension LibraryViewController: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return DataService.share.category.count
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.titleHead.text = DataService.share.category[indexPath.row].titleHeader
        cell.titleHead.textColor = DataService.share.category[indexPath.row].colorTitle
        cell.imageHeader.image = DataService.share.category[indexPath.row].iconHeader
...
extension LibraryViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return DataService.share.category[collectionView.tag].listImage.count
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.imageIcon.image = DataService.share.category[collectionView.tag].listImage[indexPath.row]
        return cell
    }
