...
class DetailLibraryViewController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if let select = indexFromLibrary {
            titleHead.text = DataService.share.category[select].titleHeader
            titleHead.textColor = DataService.share.category[select].colorTitle
        }
    }
...
extension DetailLibraryViewController: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        return DataService.share.category[indexSelected].listImage.count
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let indexSelected = indexFromLibrary {
            cell.imageIcon.image = DataService.share.category[indexSelected].listImage[indexPath.row]
        }
