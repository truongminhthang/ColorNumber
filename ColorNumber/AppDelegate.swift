...
//  ColorNumber
//
//  Created by Truong Thang on 12/26/17.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func applicationDidEnterBackground(_ application: UIApplication) {
        ...
        if UserDefaults.standard.bool(forKey: "FirstRunApp") == true {
            UserDefaults.standard.set(false, forKey: "FirstRunApp")
        }
    }
    ...
    static var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "ColorNumber")
